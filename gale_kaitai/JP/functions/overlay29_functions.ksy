doc: List of functions within OVERLAY29 with relative address locations as their
  values.
meta:
...
instances:
  ...
  play_effect_animation0x171:
    ...
    doc: |-
      ...
      r0: entity pointer
  play_effect_animation_entity_standard:
    value: 0x8078
    doc: |-
  ...
  can_monster_move_or_swap_with_ally_in_direction:
    value: 0x24c7c
    doc: |-
  ...
  should_monster_run_away_and_show_effect:
    value: 0x25338
    doc: |-
  ...
  conversion2_is_active:
    ...
    doc: |-
      ...
      r0: pointer to entity
      return: int
  reset_ai_can_attack_in_direction:
    value: 0x3d44c
    doc: |-
