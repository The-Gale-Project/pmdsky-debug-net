meta:
  ...
  endian: le
instances:
  overlay11_unknown_table_na_2316a38:
    pos: 0x3a7f8
    doc: |-
  ...
  script_op_code_names:
    pos: 0x3a8b8
    doc: Opcode name strings pointed to by entries in SCRIPT_OP_CODES (script_opcode::name)
    type: script_op_code_names_entries
    size: 0x1b18
  script_op_codes:
    pos: 0x3c3d0
    doc: |-
  ...
  overlay11_debug_strings:
    ...
    type: overlay11_debug_strings_entries
    size: 0x8e4
  c_routine_names:
    pos: 0x3d8ac
    doc: Common routine name strings pointed to by entries in C_ROUTINES (common_routine::name)
    type: c_routine_names_entries
    size: 0x2d3c
  c_routines:
    pos: 0x405e8
    doc: |-
