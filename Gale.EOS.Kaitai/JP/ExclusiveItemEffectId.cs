...
namespace Gale.EOS.Kaitai.JP
{
    ...
    /// <summary>
    /// Holds the data for the enum exclusive_item_effect_id.
    /// </summary>
    public partial class ExclusiveItemEffectId : KaitaiStruct
    {
        public static ExclusiveItemEffectId FromFile(string fileName)
        {
            return new ExclusiveItemEffectId(new KaitaiStream(fileName));
        }


        public enum ExclusiveItemEffectIdEnum
        {
        ...
        public ExclusiveItemEffectId(KaitaiStream p__io, KaitaiStruct p__parent = null, ExclusiveItemEffectId p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            _read();
        ...
        private void _read()
        {
            _exclusiveItemEffectIdValue = ((ExclusiveItemEffectIdEnum) m_io.ReadBitsIntLe(32));
        }
        private ExclusiveItemEffectIdEnum _exclusiveItemEffectIdValue;
        private ExclusiveItemEffectId m_root;
        private KaitaiStruct m_parent;
        public ExclusiveItemEffectIdEnum ExclusiveItemEffectIdValue { get { return _exclusiveItemEffectIdValue; } }
        public ExclusiveItemEffectId M_Root { get { return m_root; } }
