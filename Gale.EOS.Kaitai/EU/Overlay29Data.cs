...
namespace Gale.EOS.Kaitai.EU
{
    public partial class Overlay29Data : KaitaiStruct
    {
        ...
        public Overlay29Data(KaitaiStream p__io, KaitaiStruct p__parent = null, Overlay29Data p__root = null) : base(p__io)
        {
            ...
            f_loadedAttackSpritePackId = false;
        ...
        private bool f_loadedAttackSpritePackId;
        private PackFileId _loadedAttackSpritePackId;
        ...
        /// </summary>
        public PackFileId LoadedAttackSpritePackId
        {
            get
            {
                if (f_loadedAttackSpritePackId)
                    return _loadedAttackSpritePackId;
                long _pos = m_io.Pos;
                m_io.Seek(489006);
                _loadedAttackSpritePackId = new PackFileId(m_io);
                m_io.Seek(_pos);
                f_loadedAttackSpritePackId = true;
                return _loadedAttackSpritePackId;
            }
        }
