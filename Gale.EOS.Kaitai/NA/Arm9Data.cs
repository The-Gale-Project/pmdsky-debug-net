...
namespace Gale.EOS.Kaitai.NA
{
    public partial class Arm9Data : KaitaiStruct
    {
        ...
        public Arm9Data(KaitaiStream p__io, KaitaiStruct p__parent = null, Arm9Data p__root = null) : base(p__io)
        {
            ...
            f_damageSourceCodeNonOrbItem = false;
            ...
            f_damageSourceCodeOrbItem = false;
        ...
        private bool f_damageSourceCodeNonOrbItem;
        private DamageSourceNonMove _damageSourceCodeNonOrbItem;

        /// <summary>
        /// The damage source value for any item not in CATEGORY_ORBS, 0x263.
        /// </summary>
        public DamageSourceNonMove DamageSourceCodeNonOrbItem
        {
            get
            {
                if (f_damageSourceCodeNonOrbItem)
                    return _damageSourceCodeNonOrbItem;
                long _pos = m_io.Pos;
                m_io.Seek(51848);
                _damageSourceCodeNonOrbItem = new DamageSourceNonMove(m_io);
                m_io.Seek(_pos);
                f_damageSourceCodeNonOrbItem = true;
                return _damageSourceCodeNonOrbItem;
            }
        }
        ...
        private bool f_windowListPtr;
        private Pointer _windowListPtr;

        /// <summary>
        /// Hard-coded pointer to WINDOW_LIST.
        /// </summary>
        public Pointer WindowListPtr
        {
            get
            {
                if (f_windowListPtr)
                    return _windowListPtr;
                long _pos = m_io.Pos;
                m_io.Seek(164688);
                _windowListPtr = new Pointer(m_io);
                m_io.Seek(_pos);
                f_windowListPtr = true;
                return _windowListPtr;
            }
        }
        private bool f_logMaxArg;
        private int _logMaxArg;

        /// <summary>
        /// The maximum argument value for the Log function, 2047.
        /// </summary>
        public int LogMaxArg
        {
            get
            {
                if (f_logMaxArg)
        ...
        private bool f_damageSourceCodeOrbItem;
        private DamageSourceNonMove _damageSourceCodeOrbItem;

        /// <summary>
        /// The damage source value for any item in CATEGORY_ORBS, 0x262.
        /// </summary>
        public DamageSourceNonMove DamageSourceCodeOrbItem
        {
            get
            {
                if (f_damageSourceCodeOrbItem)
                    return _damageSourceCodeOrbItem;
                long _pos = m_io.Pos;
                m_io.Seek(51844);
                _damageSourceCodeOrbItem = new DamageSourceNonMove(m_io);
                m_io.Seek(_pos);
                f_damageSourceCodeOrbItem = true;
                return _damageSourceCodeOrbItem;
            }
        }
