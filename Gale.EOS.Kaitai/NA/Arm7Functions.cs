    ...
    public partial class Arm7Functions : KaitaiStruct
    {
        ...
        public int EnableIrqFiqFlags
        {
            get
            {
                ...
                _enableIrqFiqFlags = (int) (37248788);
        ...
        public int HardwareInterrupt
        {
            get
            {
                ...
                _hardwareInterrupt = (int) (37238384);
                f_hardwareInterrupt = true;
                return _hardwareInterrupt;
            }
        }
        private bool f_startArm7;
        private int _startArm7;
        ...
        /// No params.
        /// </summary>
        public int StartArm7
        {
            get
            {
                if (f_startArm7)
                    return _startArm7;
                _startArm7 = (int) (37224448);
                f_startArm7 = true;
                return _startArm7;
            }
        }
        ...
        public int GetCurrentPlaybackTime
        {
            get
            {
                ...
                _getCurrentPlaybackTime = (int) (37245956);
        ...
        public int GetProcessorMode
        {
            get
            {
                ...
                _getProcessorMode = (int) (37248832);
        ...
        public int AudioInterrupt
        {
            get
            {
                ...
                _audioInterrupt = (int) (37238820);
                f_audioInterrupt = true;
                return _audioInterrupt;
            }
        }
        private bool f_startAutoloadDoneCallbackArm7;
        private byte[] _startAutoloadDoneCallbackArm7;
        public byte[] StartAutoloadDoneCallbackArm7
        {
            get
            {
                if (f_startAutoloadDoneCallbackArm7)
                    return _startAutoloadDoneCallbackArm7;
                _startAutoloadDoneCallbackArm7 = m_io.ReadBytes(37224840);
        ...
        public int ReturnFromInterrupt
        {
            get
            {
                ...
                _returnFromInterrupt = (int) (37238492);
