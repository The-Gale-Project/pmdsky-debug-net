...
namespace Gale.EOS.Kaitai.NA
{
    public partial class RamData : KaitaiStruct
    {
        ...
        public RamData(KaitaiStream p__io, KaitaiStruct p__parent = null, RamData p__root = null) : base(p__io)
        {
            ...
            f_groundMemoryArena1Blocks = false;
            ...
            f_soundMemoryArenaMemory = false;
            ...
            f_groundMemoryArena2Blocks = false;
            f_teamMemberTable = false;
            f_groundMemoryArena1Ptr = false;
        ...
        private bool f_groundMemoryArena1Blocks;
        private GroundMemoryArena1BlocksArray _groundMemoryArena1Blocks;
        ...
        /// </summary>
        public GroundMemoryArena1BlocksArray GroundMemoryArena1Blocks
        {
            get
            {
                if (f_groundMemoryArena1Blocks)
                    return _groundMemoryArena1Blocks;
                long _pos = m_io.Pos;
                m_io.Seek(3297244);
                _groundMemoryArena1Blocks = new GroundMemoryArena1BlocksArray(m_io);
                m_io.Seek(_pos);
                f_groundMemoryArena1Blocks = true;
                return _groundMemoryArena1Blocks;
            }
        }
        ...
        private bool f_soundMemoryArenaMemory;
        private SoundMemoryArenaMemoryArray _soundMemoryArenaMemory;
        ...
        /// </summary>
        public SoundMemoryArenaMemoryArray SoundMemoryArenaMemory
        {
            get
            {
                if (f_soundMemoryArenaMemory)
                    return _soundMemoryArenaMemory;
                long _pos = m_io.Pos;
                m_io.Seek(2421148);
                _soundMemoryArenaMemory = new SoundMemoryArenaMemoryArray(m_io);
                m_io.Seek(_pos);
                f_soundMemoryArenaMemory = true;
                return _soundMemoryArenaMemory;
            }
        }
        ...
        private bool f_soundMemoryArenaBlocks;
        private SoundMemoryArenaBlocksArray _soundMemoryArenaBlocks;
        ...
        /// </summary>
        public SoundMemoryArenaBlocksArray SoundMemoryArenaBlocks
        {
            get
            {
                if (f_soundMemoryArenaBlocks)
                    return _soundMemoryArenaBlocks;
                long _pos = m_io.Pos;
                m_io.Seek(2420668);
                _soundMemoryArenaBlocks = new SoundMemoryArenaBlocksArray(m_io);
                m_io.Seek(_pos);
                f_soundMemoryArenaBlocks = true;
                return _soundMemoryArenaBlocks;
            }
        }
        ...
        private bool f_soundMemoryArenaPtr;
        private Pointer _soundMemoryArenaPtr;

        /// <summary>
        /// Pointer to SOUND_MEMORY_ARENA.
        /// </summary>
        public Pointer SoundMemoryArenaPtr
        {
            get
            {
                if (f_soundMemoryArenaPtr)
                    return _soundMemoryArenaPtr;
                long _pos = m_io.Pos;
                m_io.Seek(2772564);
                _soundMemoryArenaPtr = new Pointer(m_io);
                m_io.Seek(_pos);
                f_soundMemoryArenaPtr = true;
                return _soundMemoryArenaPtr;
            }
        }
        ...
        private bool f_groundMemoryArena1Memory;
        private GroundMemoryArena1MemoryArray _groundMemoryArena1Memory;

        /// <summary>
        /// The memory region for GROUND_MEMORY_ARENA_1.
        /// </summary>
        public GroundMemoryArena1MemoryArray GroundMemoryArena1Memory
        {
            get
            {
                if (f_groundMemoryArena1Memory)
                    return _groundMemoryArena1Memory;
                long _pos = m_io.Pos;
                m_io.Seek(3298492);
                _groundMemoryArena1Memory = new GroundMemoryArena1MemoryArray(m_io);
                m_io.Seek(_pos);
                f_groundMemoryArena1Memory = true;
                return _groundMemoryArena1Memory;
            }
        }
        ...
        private bool f_groundMemoryArena2Ptr;
        private Pointer _groundMemoryArena2Ptr;

        /// <summary>
        /// Pointer to GROUND_MEMORY_ARENA_2.
        /// </summary>
        public Pointer GroundMemoryArena2Ptr
        {
            get
            {
                if (f_groundMemoryArena2Ptr)
                    return _groundMemoryArena2Ptr;
                long _pos = m_io.Pos;
                m_io.Seek(3296440);
                _groundMemoryArena2Ptr = new Pointer(m_io);
                m_io.Seek(_pos);
                f_groundMemoryArena2Ptr = true;
                return _groundMemoryArena2Ptr;
            }
        }
        private bool f_sentryDutyStruct;
        private SentryDuty _sentryDutyStruct;

        /// <summary>
        /// This symbol is missing documentation.
        /// </summary>
        public SentryDuty SentryDutyStruct
        {
            get
            {
                if (f_sentryDutyStruct)
                    return _sentryDutyStruct;
                long _pos = m_io.Pos;
                m_io.Seek(3646928);
                _sentryDutyStruct = new SentryDuty(m_io);
                m_io.Seek(_pos);
                f_sentryDutyStruct = true;
                return _sentryDutyStruct;
            }
        }
        ...
        private bool f_groundMemoryArena2Blocks;
        private GroundMemoryArena2BlocksArray _groundMemoryArena2Blocks;
        ...
        /// </summary>
        public GroundMemoryArena2BlocksArray GroundMemoryArena2Blocks
        {
            get
            {
                if (f_groundMemoryArena2Blocks)
                    return _groundMemoryArena2Blocks;
                long _pos = m_io.Pos;
                m_io.Seek(1333796);
                _groundMemoryArena2Blocks = new GroundMemoryArena2BlocksArray(m_io);
                m_io.Seek(_pos);
                f_groundMemoryArena2Blocks = true;
                return _groundMemoryArena2Blocks;
            }
        }
        ...
        private bool f_groundMemoryArena1Ptr;
        private Pointer _groundMemoryArena1Ptr;

        /// <summary>
        /// Pointer to GROUND_MEMORY_ARENA_1.
        /// </summary>
        public Pointer GroundMemoryArena1Ptr
        {
            get
            {
                if (f_groundMemoryArena1Ptr)
                    return _groundMemoryArena1Ptr;
                long _pos = m_io.Pos;
                m_io.Seek(3296436);
                _groundMemoryArena1Ptr = new Pointer(m_io);
                m_io.Seek(_pos);
                f_groundMemoryArena1Ptr = true;
                return _groundMemoryArena1Ptr;
            }
        }
        ...
        private bool f_groundMemoryArena2;
        private MemArena _groundMemoryArena2;
        ...
        /// type: struct mem_arena
        /// </summary>
        public MemArena GroundMemoryArena2
        {
            get
            {
                if (f_groundMemoryArena2)
                    return _groundMemoryArena2;
                long _pos = m_io.Pos;
                m_io.Seek(1333768);
                _groundMemoryArena2 = new MemArena(m_io);
                m_io.Seek(_pos);
                f_groundMemoryArena2 = true;
                return _groundMemoryArena2;
            }
        }
        ...
        private bool f_groundMemoryArena2Memory;
        private GroundMemoryArena2MemoryArray _groundMemoryArena2Memory;

        /// <summary>
        /// The memory region for GROUND_MEMORY_ARENA_2.
        /// </summary>
        public GroundMemoryArena2MemoryArray GroundMemoryArena2Memory
        {
            get
            {
                if (f_groundMemoryArena2Memory)
                    return _groundMemoryArena2Memory;
                long _pos = m_io.Pos;
                m_io.Seek(1334564);
                _groundMemoryArena2Memory = new GroundMemoryArena2MemoryArray(m_io);
                m_io.Seek(_pos);
                f_groundMemoryArena2Memory = true;
                return _groundMemoryArena2Memory;
            }
        }
        ...
        private bool f_soundMemoryArena;
        private MemArena _soundMemoryArena;
        ...
        /// type: struct mem_arena
        /// </summary>
        public MemArena SoundMemoryArena
        {
            get
            {
                if (f_soundMemoryArena)
                    return _soundMemoryArena;
                long _pos = m_io.Pos;
                m_io.Seek(2420640);
                _soundMemoryArena = new MemArena(m_io);
                m_io.Seek(_pos);
                f_soundMemoryArena = true;
                return _soundMemoryArena;
            }
        }
