...
namespace Gale.EOS.Kaitai.NA
{
    public partial class Overlay18Data : KaitaiStruct
    {
        ...
        public Overlay18Data(KaitaiStream p__io, KaitaiStruct p__parent = null, Overlay18Data p__root = null) : base(p__io)
        {
            m_parent = p__parent;
            m_root = p__root ?? this;
            f_overlay18UnknownPointerNa238d620 = false;
            ...
            f_overlay18UnknownPointerNa238d624 = false;
            ...
            f_overlay18ReservedSpace = false;
            f_overlay18UnknownPointerNa238d628 = false;
        ...
        private bool f_overlay18UnknownPointerNa238d620;
        private List<byte> _overlay18UnknownPointerNa238d620;

        /// <summary>
        /// Note: unverified, ported from Irdkwia's notes
        /// </summary>
        public List<byte> Overlay18UnknownPointerNa238d620
        {
            get
            {
                if (f_overlay18UnknownPointerNa238d620)
                    return _overlay18UnknownPointerNa238d620;
                long _pos = m_io.Pos;
                m_io.Seek(13536);
                _overlay18UnknownPointerNa238d620 = new List<byte>();
                for (var i = 0; i < 4; i++)
                {
                    _overlay18UnknownPointerNa238d620.Add(m_io.ReadU1());
                }
                m_io.Seek(_pos);
                f_overlay18UnknownPointerNa238d620 = true;
                return _overlay18UnknownPointerNa238d620;
            }
        }
        ...
        private bool f_overlay18UnknownPointerNa238d624;
        private List<byte> _overlay18UnknownPointerNa238d624;

        /// <summary>
        /// Note: unverified, ported from Irdkwia's notes
        /// </summary>
        public List<byte> Overlay18UnknownPointerNa238d624
        {
            get
            {
                if (f_overlay18UnknownPointerNa238d624)
                    return _overlay18UnknownPointerNa238d624;
                long _pos = m_io.Pos;
                m_io.Seek(13540);
                _overlay18UnknownPointerNa238d624 = new List<byte>();
                for (var i = 0; i < 4; i++)
                {
                    _overlay18UnknownPointerNa238d624.Add(m_io.ReadU1());
                }
                m_io.Seek(_pos);
                f_overlay18UnknownPointerNa238d624 = true;
                return _overlay18UnknownPointerNa238d624;
            }
        }
        ...
        private bool f_overlay18ReservedSpace;
        private List<byte> _overlay18ReservedSpace;

        /// <summary>
        /// Note: unverified, ported from Irdkwia's notes
        /// </summary>
        public List<byte> Overlay18ReservedSpace
        {
            get
            {
                if (f_overlay18ReservedSpace)
                    return _overlay18ReservedSpace;
                long _pos = m_io.Pos;
                m_io.Seek(13532);
                _overlay18ReservedSpace = new List<byte>();
                for (var i = 0; i < 4; i++)
                {
                    _overlay18ReservedSpace.Add(m_io.ReadU1());
                }
                m_io.Seek(_pos);
                f_overlay18ReservedSpace = true;
                return _overlay18ReservedSpace;
            }
        }
        private bool f_overlay18UnknownPointerNa238d628;
        private List<byte> _overlay18UnknownPointerNa238d628;

        /// <summary>
        /// Note: unverified, ported from Irdkwia's notes
        /// </summary>
        public List<byte> Overlay18UnknownPointerNa238d628
        {
            get
            {
                if (f_overlay18UnknownPointerNa238d628)
                    return _overlay18UnknownPointerNa238d628;
                long _pos = m_io.Pos;
                m_io.Seek(13544);
                _overlay18UnknownPointerNa238d628 = new List<byte>();
                for (var i = 0; i < 4; i++)
                {
                    _overlay18UnknownPointerNa238d628.Add(m_io.ReadU1());
                }
                m_io.Seek(_pos);
                f_overlay18UnknownPointerNa238d628 = true;
                return _overlay18UnknownPointerNa238d628;
            }
        }
