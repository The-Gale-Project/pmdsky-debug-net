...
namespace Gale.EOS.Kaitai.NA
{
    public partial class Overlay20Data : KaitaiStruct
    {
        ...
        public Overlay20Data(KaitaiStream p__io, KaitaiStruct p__parent = null, Overlay20Data p__root = null) : base(p__io)
        {
            ...
            f_overlay20ReservedSpace = false;
        ...
        private bool f_overlay20UnknownPointerNa238cf7c;
        private List<byte> _overlay20UnknownPointerNa238cf7c;

        /// <summary>
        /// Note: unverified, ported from Irdkwia's notes
        /// </summary>
        public List<byte> Overlay20UnknownPointerNa238cf7c
        {
            get
            {
                if (f_overlay20UnknownPointerNa238cf7c)
                    return _overlay20UnknownPointerNa238cf7c;
                long _pos = m_io.Pos;
                m_io.Seek(11836);
                _overlay20UnknownPointerNa238cf7c = new List<byte>();
                for (var i = 0; i < 8; i++)
                {
                    _overlay20UnknownPointerNa238cf7c.Add(m_io.ReadU1());
                }
                m_io.Seek(_pos);
                f_overlay20UnknownPointerNa238cf7c = true;
                return _overlay20UnknownPointerNa238cf7c;
            }
        }
        ...
        private bool f_overlay20UnknownTableNa238d014;
        private List<byte> _overlay20UnknownTableNa238d014;

        /// <summary>
        /// Note: unverified, ported from Irdkwia's notes
        /// </summary>
        public List<byte> Overlay20UnknownTableNa238d014
        {
            get
            {
                if (f_overlay20UnknownTableNa238d014)
                    return _overlay20UnknownTableNa238d014;
                long _pos = m_io.Pos;
                m_io.Seek(11988);
                _overlay20UnknownTableNa238d014 = new List<byte>();
                for (var i = 0; i < 20; i++)
                {
                    _overlay20UnknownTableNa238d014.Add(m_io.ReadU1());
                }
                m_io.Seek(_pos);
                f_overlay20UnknownTableNa238d014 = true;
                return _overlay20UnknownTableNa238d014;
            }
        }
        ...
        private bool f_overlay20ReservedSpace;
        private List<byte> _overlay20ReservedSpace;

        /// <summary>
        /// Note: unverified, ported from Irdkwia's notes
        /// </summary>
        public List<byte> Overlay20ReservedSpace
        {
            get
            {
                if (f_overlay20ReservedSpace)
                    return _overlay20ReservedSpace;
                long _pos = m_io.Pos;
                m_io.Seek(12240);
                _overlay20ReservedSpace = new List<byte>();
                for (var i = 0; i < 16; i++)
                {
                    _overlay20ReservedSpace.Add(m_io.ReadU1());
                }
                m_io.Seek(_pos);
                f_overlay20ReservedSpace = true;
                return _overlay20ReservedSpace;
            }
        }
